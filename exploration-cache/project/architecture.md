...
- Client UI layer includes Sprint 1 admin screens, Sprint 2 Party list/detail/edit draft, Sprint 3 document list/detail/create/referrer draft, and Sprint 4 invoice payment draft; Sprint 5 penalties/creances is backend-only so far; epargne data sources remain future work
