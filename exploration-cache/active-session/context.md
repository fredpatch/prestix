...
Cache/task sync after Sprint 2 Party/Credit backend draft.

## State of the codebase

Backend has working Express routes for bootstrap, auth, users, settings, Party,
and Credit/Avoir, with JWT cookie auth, RBAC middleware, and default settings seed.
...
- Party/Credit backend routes are mounted; `npm run typecheck -w packages/server` passes, authenticated API smoke still pending.
