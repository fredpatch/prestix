...
- Current phase: Sprint 2 Party/Credit backend draft in progress
- Ports: API 3000, client dev 5173
- Blockers cleared: EPARGNE_INSCRIPTION_FEE = 5000 XAF, prm = Premium
- API health endpoint: GET /api/health
- Open: Party/Credit API smoke, Party UI/history, migration policy decisions, Beta prod data access (Sprint 11)
