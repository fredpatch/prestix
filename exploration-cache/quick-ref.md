...
- Current phase: Sprint 4 Payments backend draft in progress
- Ports: API 3000, client dev 5173
- Blockers cleared: EPARGNE_INSCRIPTION_FEE = 5000 XAF, prm = Premium
- API health endpoint: GET /api/health
- Open: Payment migration/API smoke, Document migration/API/client smoke, Party/Credit/History API + client smoke, Beta prod data access (Sprint 11)
