...
- Current phase: Sprint 3 Document UI draft in progress
- Ports: API 3000, client dev 5173
- Blockers cleared: EPARGNE_INSCRIPTION_FEE = 5000 XAF, prm = Premium
- API health endpoint: GET /api/health
- Open: Document migration/API/client smoke, Party/Credit/History API + client smoke, migration policy decisions, Beta prod data access (Sprint 11)
