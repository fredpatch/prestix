  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-[12.5px] font-semibold text-neutral-800",
        nav: "flex items-center justify-between absolute inset-x-0 top-0 h-8 px-1",
        button_previous: cn(
          "inline-flex items-center justify-center h-7 w-7 rounded-md text-neutral-500",
          "hover:bg-neutral-100 hover:text-neutral-800 disabled:opacity-30 disabled:pointer-events-none",
        ),
        button_next: cn(
          "inline-flex items-center justify-center h-7 w-7 rounded-md text-neutral-500",
          "hover:bg-neutral-100 hover:text-neutral-800 disabled:opacity-30 disabled:pointer-events-none",
        ...
        weekdays: "flex",
        weekday: "text-neutral-400 w-8 text-[10.5px] font-medium text-center",
        week: "flex w-full mt-1",
        day: "h-8 w-8 text-center text-[11.5px] p-0 relative",
        day_button: cn(
          "h-8 w-8 rounded-md text-neutral-800 inline-flex items-center justify-center",
          "hover:bg-neutral-100 aria-selected:opacity-100",
        ),
        selected: cn(
